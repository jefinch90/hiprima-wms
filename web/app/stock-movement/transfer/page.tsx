        ...
        <main className="min-w-0 max-w-full flex-1 overflow-x-hidden p-6 md:p-10">
          ...
          <div className="mx-auto w-full min-w-0 max-w-[1400px]">
            ...
            <header className="mb-8">
              ...
              <div className="mt-1 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                ...
                <Link
                  ...
                  className="shrink-0 rounded-xl bg-slate-900 px-5 py-3 text-center text-sm font-medium text-white"
                >
                  Transfer Stock
                </Link>
            ...
            <section className="w-full min-w-0 max-w-full overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
              ...
              {/* DESKTOP TABLE - TANPA HORIZONTAL SCROLL */}
              ...
              {/* TABLET / MOBILE = CARD, BUKAN TABEL LEBAR */}

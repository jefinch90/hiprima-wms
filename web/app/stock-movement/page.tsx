              ...
              <div className="mt-1 flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
                <div className="min-w-0">
                  ...
                  <p className="mt-2 text-sm text-slate-500">
                    Riwayat pergerakan stok Warehouse
                    Management System
                  </p>
                </div>
            ...
            <section className="mb-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              >
                <input
                  ...
                  className="min-w-0 rounded-xl border border-slate-300 px-4 py-3 text-sm outline-none focus:border-slate-500"
                />
                ...
                {(search || typeFilter) && (
                  <button
                    type="button"
                    onClick={handleReset}
                    className="rounded-xl border border-slate-300 bg-white px-5 py-3 text-sm"
                  >
                    Reset
                  </button>
                )}
            ...
            <section className="w-full min-w-0 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
              <div className="flex flex-col gap-2 border-b border-slate-200 p-6 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-500">
                    {formatNumber(totalCount)} movement
                    ditemukan
                  </p>
                </div>
              ...
              <div className="flex flex-col gap-4 border-t border-slate-200 p-5 sm:flex-row sm:items-center sm:justify-between">
                <div className="text-sm text-slate-500">
                  Maksimal {pageSize} movement per
                  halaman
                </div>
